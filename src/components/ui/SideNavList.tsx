...
/** The grouped list. Rendered in the desktop column and in the phone drawer. */
export default function SideNavList({
  groups, ariaLabel, onNavigate,
}: {
  groups: NavGroup[];
  ariaLabel: string;
        ...
        <Box key={group.title}>
          ...
          <Stack spacing={0.25}>
            {group.items.map((item) => {
              ...
              return (
                <NextLink key={item.href} href={item.href} onClick={onNavigate}
